...
export default function AdditionalSport({additionalSports, handleAddNew, handleEdit, handleDelete}){
...
function AdditionalSports({additionalSports, handleEdit, handleDelete}){
    const isMobile = window.innerWidth < 500
    return (
        <TransitionGroup >
