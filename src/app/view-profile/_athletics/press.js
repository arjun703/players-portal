...
export default function PressOrInterview({pressesOrInterviews, handleAddNewPressOrInterview, handleEditPressOrInterview, handleDeletePressOrInterview}){
...
function PressesOrInterviews({pressesOrInterviews, handleEdit, handleDelete}){
