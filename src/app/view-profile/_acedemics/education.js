                        ...
                        : editingEducation.isEditing
                            ...
                            <>
                                {educations.length
                                    ...
                                    : <NoEducationBlock handleInitiateAddNewEducation={handleInitiateAddNewEducation} />
                                }
                            </>
...
function Educations({ educations, editEducation, deleteEducation }) {
    const isMobile = window.innerWidth < 500
    return (
        <TransitionGroup >
...
function NoEducationBlock({ handleInitiateAddNewEducation }) {
    return (
